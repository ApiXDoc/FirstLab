...
public class DatabaseHelper_Book3 extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "book3.db";
    ...
    public DatabaseHelper_Book3(Context context) {
